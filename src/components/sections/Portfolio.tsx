...
const portfolioItems: PortfolioItem[] = [
  { id: 1, image: '/portfolio1.jpg', title: '青木棕波浪捲', stylist: 'Michael', color: '#4A6741', category: 'long' },
  { id: 2, image: '/portfolio2.jpg', title: '冷棕茶短髮', stylist: 'Sarah', color: '#5C4A3A', category: 'short' },
  { id: 3, image: '/portfolio3.jpg', title: '微醺蜜粉層次', stylist: 'Tina', color: '#D4A5A5', category: 'color' },
  { id: 4, image: '/portfolio4.jpg', title: '韓系紋理燙', stylist: 'Michael', color: '#3D3229', category: 'men' },
  { id: 5, image: '/portfolio5.jpg', title: '灰霧感大捲', stylist: 'Jessica', color: '#6B5B5B', category: 'long' },
  { id: 6, image: '/portfolio6.jpg', title: '焦糖棕肩上短', stylist: 'Sarah', color: '#8B5A2B', category: 'short' },
  { id: 7, image: '/portfolio7.jpg', title: '法式金邊美甲', stylist: 'Tina', color: '#E8D4D4', category: 'nail' },
  { id: 8, image: '/portfolio8.jpg', title: '光線染漸層', stylist: 'Jessica', color: '#A67B5B', category: 'color' },
];
              ...
              {column.map((item, itemIndex) => (
                ...
                >
                  <div className="relative aspect-[3/4]">
                    ...
                    {/* Color Tag */}
                    <div className="absolute top-4 right-4 w-6 h-6 rounded-full border-2 border-white/70 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                      style={{ backgroundColor: item.color }}
                    />
                  </div>
                </div>
