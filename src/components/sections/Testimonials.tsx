      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-16 px-6 sm:px-8 lg:px-16 xl:px-24">
          ...
          >
            <div className="flex">
              {[...Array(5)].map((_, i) => (
                <Star key={`star-header-${i}`} className="w-5 h-5 fill-[hsl(var(--soft-gold))] text-[hsl(var(--soft-gold))]" />
              ))}
            </div>
                  ...
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 h-full shadow-sm hover:shadow-md transition-shadow duration-300">
                    ...
                    <div className="flex gap-1 mb-4">
                      {[...Array(testimonial.rating)].map((_, i) => (
                        <Star key={`star-${testimonial.id}-${i}`} className="w-4 h-4 fill-[hsl(var(--soft-gold))] text-[hsl(var(--soft-gold))]" />
                      ))}
                    </div>
          ...
          {testimonials.slice(0, 3).map((testimonial, index) => (
            ...
            >
              <div className="flex gap-1 mb-3">
                {[...Array(testimonial.rating)].map((_, i) => (
                  <Star key={`star-mobile-${testimonial.id}-${i}`} className="w-4 h-4 fill-[hsl(var(--soft-gold))] text-[hsl(var(--soft-gold))]" />
                ))}
              </div>
